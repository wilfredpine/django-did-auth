...
from django_sauth.core.flows.login_flow import login_user
from django_sauth.hooks.role_hooks import redirect_by_role
...
def login_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if status == "success":
                ...
                from django_sauth.hooks.auth_hooks import on_login_success
    ...
    return render(request, "sauth/login.html", {"form": form})